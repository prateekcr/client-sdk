			 ...
			 char *tpmHMACPriv_key)
{
	...
	size_t offset = 0;
	uint8_t bufferTPMHMACPriv_key_size = 0;
	...
	if (file_size == TPM_HMAC_PRIV_KEY_CONTEXT_SIZE_128) {
		bufferTPMHMACPriv_key_size = TPM_HMAC_PRIV_KEY_CONTEXT_SIZE_128;
	} else if (file_size == TPM_HMAC_PRIV_KEY_CONTEXT_SIZE_160) {
		bufferTPMHMACPriv_key_size = TPM_HMAC_PRIV_KEY_CONTEXT_SIZE_160;
	} else {
	...
	uint8_t bufferTPMHMACPriv_key[bufferTPMHMACPriv_key_size] = {0};
